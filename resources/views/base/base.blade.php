...
<body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="img/IMG-20200804-WA0093.jpg" alt="" />
                <!-- Icon Divider-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">This is my portfolio website were i have posted some stuff that i did.</p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead">I am a still a apprentice in programming but i am driven programmer that has a lot of fun and irretation during my projects.</p></div>
                </div>
        ...
        <footer class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">My hobbies</h4>
                        <p class="lead mb-0">
                           I like programming working together and having fun with friends and colleges.
